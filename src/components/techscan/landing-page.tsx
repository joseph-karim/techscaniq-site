    ...
    <div className="relative min-h-screen bg-brand-white font-ibm text-brand-black">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h2 className="text-2xl md:text-3xl font-space font-normal text-brand-gunmetal leading-relaxed">
      ...
      <section className="bg-gray-50 py-20 md:py-32">
        <div className="container mx-auto px-6">
          ...
          {/* Desktop Table */}
          <div className="hidden md:block bg-brand-white rounded-lg border border-gray-200 overflow-hidden">
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  <th className="text-left py-6 px-8 font-space font-medium text-brand-black">The Old Way</th>
                  <th className="text-left py-6 px-8 font-space font-medium text-brand-teal">TechScanIQ</th>
                </tr>
              </thead>
              <tbody>
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-8 font-ibm text-brand-gunmetal">3-week consultant engagement at $25K+</td>
                  <td className="py-4 px-8 font-ibm text-brand-black">48-hour flat-fee report</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-8 font-ibm text-brand-gunmetal">Generic technical checklist</td>
                  <td className="py-4 px-8 font-ibm text-brand-black">Thesis-weighted scoring</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-4 px-8 font-ibm text-brand-gunmetal">Black-box findings you can't verify</td>
                  <td className="py-4 px-8 font-ibm text-brand-black">Every risk linked to source evidence</td>
                </tr>
                <tr>
                  <td className="py-4 px-8 font-ibm text-brand-gunmetal">Junior analyst guesswork</td>
                  <td className="py-4 px-8 font-ibm text-brand-black">Senior engineer sign-off</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div className="md:hidden space-y-8">
            <div className="bg-brand-white p-6 rounded-lg border border-gray-200">
              <h3 className="font-space font-medium text-brand-black mb-4">The Old Way</h3>
              <ul className="space-y-3 font-ibm text-brand-gunmetal">
            ...
            <div className="bg-brand-white p-6 rounded-lg border border-brand-teal">
              <h3 className="font-space font-medium text-brand-teal mb-4">TechScanIQ</h3>
              <ul className="space-y-3 font-ibm text-brand-black">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-brand-white p-8 rounded-lg border border-gray-200 group hover:border-brand-teal transition-all duration-300">
              ...
              <h3 className="text-xl font-space font-medium text-brand-black mb-3">Define Your Thesis</h3>
            ...
            <div className="bg-brand-white p-8 rounded-lg border border-gray-200 group hover:border-brand-teal transition-all duration-300">
              ...
              <h3 className="text-xl font-space font-medium text-brand-black mb-3">Upload Securely</h3>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">
            ...
            <div className="bg-brand-white p-8 rounded-lg border border-gray-200 group hover:border-brand-teal transition-all duration-300">
              ...
              <h3 className="text-xl font-space font-medium text-brand-black mb-3">Get Actionable Intelligence</h3>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">
      ...
      <section className="bg-gray-50 py-20 md:py-32">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl font-ibm text-brand-gunmetal leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-brand-white p-6 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300">
              ...
              <h4 className="font-space font-medium text-brand-black mb-3">Secure Handling</h4>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">Single-tenant containers. Encrypted transit and storage. Automatic data deletion.</p>
            </div>
            ...
            <div className="bg-brand-white p-6 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300">
              ...
              <h4 className="font-space font-medium text-brand-black mb-3">AI + Human Verification</h4>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">200+ automated checks validated by senior engineers who stake their reputation on every report.</p>
            </div>
            ...
            <div className="bg-brand-white p-6 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300">
              ...
              <h4 className="font-space font-medium text-brand-black mb-3">Thesis Alignment</h4>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">Your growth vs. efficiency priorities drive our scoring algorithm, not generic best practices.</p>
            </div>
            ...
            <div className="bg-brand-white p-6 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300">
              ...
              <h4 className="font-space font-medium text-brand-black mb-3">Evidence Trail</h4>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">Click any finding to see the exact code line, dependency conflict, or architectural issue.</p>
            </div>

            <div className="bg-brand-white p-6 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300 md:col-span-2 lg:col-span-1">
              <div className="bg-brand-teal/10 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
                <FileCheck className="h-6 w-6 text-brand-teal" />
              </div>
              <h4 className="font-space font-medium text-brand-black mb-3">Professional Documentation</h4>
              <p className="font-ibm text-brand-gunmetal leading-relaxed">Timestamped PDF and XLSX exports. API integration with DealRoom and other platforms.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 md:py-32">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-brand-white p-8 rounded-lg border border-gray-200 hover:border-brand-teal transition-all duration-300">
              <div className="mb-6">
                <h3 className="text-2xl font-space font-medium text-brand-black mb-2">Public Scan</h3>
                <p className="font-ibm text-brand-gunmetal mb-4">Early-stage evaluation</p>
                <div className="text-3xl font-space font-medium text-brand-black mb-2">$499</div>
                <p className="font-ibm text-brand-gunmetal text-sm">24 hours</p>
              </div>
            ...
            <div className="bg-brand-white p-8 rounded-lg border-2 border-brand-teal relative">
              ...
              <div className="mb-6">
                <h3 className="text-2xl font-space font-medium text-brand-black mb-2">Deep Scan</h3>
                <p className="font-ibm text-brand-gunmetal mb-4">Final diligence with repo access</p>
                <div className="text-3xl font-space font-medium text-brand-black mb-2">Custom Quote</div>
                <p className="font-ibm text-brand-gunmetal text-sm">48 hours</p>
              </div>
              <ul className="space-y-3 font-ibm text-brand-gunmetal mb-8">
                <li className="flex items-start">
                  <Check className="h-5 w-5 text-brand-teal mr-2 mt-0.5 flex-shrink-0" />
      ...
      <footer className="bg-brand-white border-t border-gray-200 py-12">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              <h5 className="font-space font-medium text-brand-black mb-3">Resources</h5>
              <ul className="space-y-2 font-ibm text-brand-gunmetal text-sm">
