        ...
        <div className="p-6 max-h-[80vh] overflow-y-auto">
          <div className="mb-6 pb-4 border-b border-[#1E3A5F]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4">
              ...
              <div className="flex items-center">
                <FileSpreadsheet className="h-4 w-4 text-[#22D3EE] mr-2" />
                <span className="text-sm"><span className="text-gray-400">Vertical:</span> B2B Workflow</span>
              </div>
              <div className="flex items-center">
                <Calendar className="h-4 w-4 text-[#22D3EE] mr-2" />
          ...
          <div className="space-y-6">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="bg-[#12263A] p-4 rounded-lg border border-[#1E3A5F]">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-2">
                <div className="flex items-start">
                  <Check className="h-4 w-4 text-green-400 mt-1 mr-2" />
            ...
            <section className="bg-[#12263A] p-6 rounded-lg border border-[#1E3A5F]">
              <h3 className="text-xl font-semibold text-[#22D3EE] mb-3">Investor Takeaways</h3>
