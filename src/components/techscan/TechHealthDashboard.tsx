import { ArrowRight, Check, FileWarning, AlertTriangle, ChevronDown } from "lucide-react";
...
export function TechHealthDashboard({
  ...
  useEffect(() => {
    ...
    const sections = ["score", "redFlags", "stack", "memo"];
    let currentIndex = 0;
    
    const expandInterval = setInterval(() => {
      if (currentIndex < sections.length) {
        setOpenSections(prev => [...prev, sections[currentIndex]]);
        currentIndex++;
      } else {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="space-y-6">
          ...
          <Accordion 
            ...
            className="border-0"
          >
            <AccordionItem value="score" className="border-b border-[#1E3A5F]">
              <AccordionTrigger 
                onClick={() => handleAccordionChange("score")}
                className="text-2xl font-bold py-4 hover:no-underline hover:bg-[#1E3A5F]/20 px-3 rounded-t-lg"
              >
                Tech Health Score
              </AccordionTrigger>
            ...
            {/* Stack Overview Accordion */}
            <AccordionItem value="stack" className="border-b border-[#1E3A5F]">
              <AccordionTrigger 
                onClick={() => handleAccordionChange("stack")}
                className="text-2xl font-bold py-4 hover:no-underline hover:bg-[#1E3A5F]/20 px-3"
              >
                Stack Overview
              </AccordionTrigger>
              <AccordionContent className="pt-4 px-2">
        ...
        <div className="space-y-6">
          ...
          <Accordion 
            ...
            className="border-0"
          >
            <AccordionItem value="redFlags" className="border-b border-[#1E3A5F]">
              <AccordionTrigger 
                onClick={() => handleAccordionChange("redFlags")}
                className="text-2xl font-bold py-4 hover:no-underline hover:bg-[#1E3A5F]/20 px-3 rounded-t-lg"
              >
            ...
            {/* Investment Memo Accordion */}
            <AccordionItem value="memo" className="border-b border-[#1E3A5F]">
              <AccordionTrigger 
                onClick={() => handleAccordionChange("memo")}
                className="text-2xl font-bold py-4 hover:no-underline hover:bg-[#1E3A5F]/20 px-3"
              >
