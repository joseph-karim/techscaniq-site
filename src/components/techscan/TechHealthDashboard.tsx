...
export function TechHealthDashboard({
  ...
  return (
    <div className={`bg-[#0A1A2F] rounded-xl border border-[#1E3A5F] text-white shadow-xl ${className}`}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-6">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 mt-8">
            <h2 className="text-2xl font-bold">Stack Overview</h2>
        ...
        <div className="space-y-6">
          {/* Red Flags Table */}
          <div className="space-y-4">
            <h2 className="text-2xl font-bold">Red Flags & Risk Factors</h2>
            <div className="space-y-2">
          ...
          <div className="space-y-4 mt-8">
            <h2 className="text-2xl font-bold">LP-Ready Investment Memo</h2>
